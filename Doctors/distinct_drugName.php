...
<div id="content">
    ...
    <p>Here are the list of all the distinct named drugs avaliable in the clinic:</p>
            ...
            <?php
                ...
                else
                {
                    while( $row = sqlsrv_fetch_array( $drugs) )
                    {
                        ...
                        if($alt_count%2==0)
                        {
                            echo "<tr> <td>". $row['name']."</td> <td>". $row['ingredient']."</td> </tr>";
                        }
                        else
                        {
                            echo "<tr class=\"alt\"> <td>". $row['name']."</td> <td>". $row['ingredient']."</td> </tr>";
                        }
                        $alt_count++;
                    }
                }
