...
<div id="content">
    ...
    <p>Here is the list of patients who have visited you the maximum number of times. Only the patient with maximum number of visits is shown. If two or more patients have visited you the same number of times, then all of them are displayed.</p>
