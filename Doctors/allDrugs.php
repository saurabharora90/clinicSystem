...
<div id="content">
    ...
    <p>Here are the list of all the drugs avaliable in the clinic:</p>
            ...
            <?php
                ...
                else
                {
                    while( $row = sqlsrv_fetch_array( $drugs) )
                    {
                        ...
                        if($alt_count%2==0)
                        {
                            echo "<tr> <td>". $row[0]."</td> <td>".$row[1]."</td> <td>". $row['ingredient']."</td> </tr>";
                        }
                        else
                        {
                            echo "<tr class=\"alt\"> <td>". $row['name']."</td> <td>".$row['manu']."</td> <td>". $row['ingredient']."</td> </tr>";
                        }
                        $alt_count++;
                    }
                }
